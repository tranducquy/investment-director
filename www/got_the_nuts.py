...
def open_signal():
    signal="active"
    #symbol1 = request.args.get("symbol", "Nikkei225_TOPIX_20190923.txt")
    ...
    symbol4 = request.args.get("symbol", "close_on_daily_20191113_1570.txt")
...
def symbols():
    symbols = "active"
    symbol1 = request.args.get("symbol1", "Nikkei225_TOPIX_20190923.txt")
